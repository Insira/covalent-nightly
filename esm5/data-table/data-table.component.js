...
var TdDataTableComponent = /** @class */ (function(_super) {
    ...
    get: function() {
      ...
      if (this.hasData) {
        ...
        Object.keys(row).forEach(function(k) {
          if (
            !_this._columns.find(function(c) {
              return c.name === k;
            })
          ) {
   ...
   */ = function() {
    ...
    this._horizontalScrollSubs = this._onHorizontalScroll
      .asObservable()
    ...
    this._verticalScrollSubs = this._onVerticalScroll
      .asObservable()
        ...
        if (
          ...
          for (var i = firstIndex; i <= lastIndex; i++) {
            ...
            if (
              ...
              if (
                (currentSelected >= this._firstSelectedIndex &&
                  currentSelected <= this._lastSelectedIndex) ||
                (currentSelected <= this._firstSelectedIndex &&
                  currentSelected >= this._lastSelectedIndex)
              ) {
                this._doSelection(this._data[i], i);
    ...
    switch (event.keyCode) {
      ...
      case DOWN_ARROW:
        ...
        if (
          ...
          this.multiple &&
          event.shiftKey &&
          this.fromRow + index < this._data.length
        ) {
          this._doSelection(this._data[this.fromRow + index], this.fromRow + index);
        }
        break;
   ...
   */ = function(event) {
    ...
    if (this._resizingColumn !== undefined && event.clientX > 0) {
      ...
      if (xPosition > 0 && this._columnClientX > 0 && xPosition - this._columnClientX !== 0) {
        ...
        /** @type {?} */
        var proposedManualWidth =
          this._widths[this._resizingColumn].value + (xPosition - this._columnClientX);
   ...
   */ = function() {
    ...
    if (this._data) {
      this._allSelected =
        typeof this._data.find(function(d) {
          return !_this.isRowSelected(d);
        }) === 'undefined';
      this._indeterminate = false;
      try {
   ...
   */ = function() {
    ...
    if (flexibleWidths && recalculateHostWidth) {
      ...
      this._widths.forEach(function(colWidth) {
        if (
          (_this._widths[colWidth.index].max && _this._widths[colWidth.index].value > newValue_1) ||
   ...
   */ = function() {
    /** @type {?} */
    var renderedColumns = this.columns.filter(function(col) {
      return !col.hidden;
    });
