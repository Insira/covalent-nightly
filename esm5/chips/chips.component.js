...
var TdChipsComponent = /** @class */ (function(_super) {
   ...
   */ = function(value) {
    ...
    if (
      this.value.findIndex(function(item) {
        return _this.compareWith(item, value);
      }) > -1
    ) {
      return false;
    }
